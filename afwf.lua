...
function Luxt1.CreateWindow(libName, logoID)
    ...
    key1.Text = "LeftAlt"
    key1.TextColor3 = Color3.fromRGB(255, 200, 0)
    ...
    logoId = logoId or "101824176106940"
    ...
    hubLogo.ZIndex = 2
    hubLogo.Image = "rbxassetid://101824176106940"
    ...
    hubName.TextColor3 = Color3.fromRGB(255, 200, 0)
    ...
    usename.TextColor3 = Color3.fromRGB(145, 114, 1)
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        tabBtn.BackgroundColor3 = Color3.fromRGB(87, 75, 30)
        ...
        tabBtn.Text = tabText
        tabBtn.TextColor3 = Color3.fromRGB(255, 200, 0)
        ...
        tabLogo.ImageColor3 = Color3.fromRGB(255, 200, 0)
        --
                    ...
                    for i,v in next, v:GetChildren() do
                        if v:IsA("TextButton") then
                            game.TweenService:Create(v, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
                                TextColor3 = Color3.fromRGB(87, 75, 30)
                            }):Play()
                        end
                        if v:IsA("ImageLabel") then
                            game.TweenService:Create(v, TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.In), {
                                ImageColor3 = Color3.fromRGB(87, 75, 30)
                            }):Play()
                        end
                    end
                end
        ...
        function sectionHandling:Section(sectionText)
            ...
            sectionName.TextColor3 = Color3.fromRGB(255, 200, 0)
            ...
            sectionExpannd.ImageColor3 = Color3.fromRGB(255, 200, 0)
            ...
            function ItemHandling:Button(btnText, callback)
                ...
                TextButton.MouseButton1Down:Connect(function()
                    if not debounce1 then
                        ...
                        game.TweenService:Create(TextButton, TweenInfo.new(0.18, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),{
                            BackgroundColor3 = Color3.fromRGB(87, 75, 30),
                ...
                function ItemHandling:Toggle(toggInfo, callback)
                    ...
                    checkBtn.MouseButton1Click:Connect(function()
                        if not togDe then
                                ...
                                on = not on
                                 callback(on) 
                                if on then
                                    checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(255, 200, 0)
                                    checkBtn.ImageColor3 = Color3.fromRGB(255, 200, 0)
                    ...
                    function ItemHandling:KeyBind(keyInfo, first, callback)
                        ...
                        function ItemHandling:TextBox(infbix, textPlace, callback)
                            ...
                            TextBox.BackgroundColor3 = Color3.fromRGB(255, 200, 0)
                            ...
                            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                                ...
                                dragSlider.BackgroundColor3 = Color3.fromRGB(255, 200, 0)
                            ...
                            function ItemHandling:Credit(creditWho)
                                ...
                                function ItemHandling:DropDown(dropInfo, list, callback)
                                    ...
                                    expand_more.ImageColor3 = Color3.fromRGB(255, 200, 0)
                                    ...
                                    dropdownItem1.TextColor3 = Color3.fromRGB(255, 200, 0)
                                    ...
                                    for i,v in next, list do
                                        ...
                                        optionBtn1.Text = "  "..v
                                        optionBtn1.TextColor3 = Color3.fromRGB(87, 75, 30)
